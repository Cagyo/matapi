...
| ------------------------------------------------------------------------------- | --------------------------------- | -------------------------- | ----------------------------------------------------------- |
| Focused automated handler, cleanup, registration, live-stream, and locale tests | Local CI-compatible environment   | PASS                       | 41 files / 298 tests passed with scoped loopback permission. |
...
| Full automated regression suite                                                 | Local CI-compatible environment   | PASS                       | 167 files / 1010 tests passed with scoped loopback permission. |
