...
const enCatalog = {
  ...
  feature: {
    ...
    failure: { 'request-invalid': 'invalid install request', 'request-publish-failed': 'request could not be queued', 'dependency-install-failed': 'dependency installation failed', 'privileged-verification-failed': 'privileged verification failed', 'application-verification-failed': 'application verification failed', 'partial-state-uncertain': 'state needs repair', 'helper-version-mismatch': 'installer update required', 'result-invalid': 'invalid installer result', interrupted: 'installation interrupted' },
